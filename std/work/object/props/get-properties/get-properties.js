...
/**
  * Get object's own properties (names and symbols)
  * @param {object}  obj  An object to get properties of.
  * @returns {array}  Own properties (enumerable or not) of an object.
  */
function getOwnProperties(obj) {
    return Reflect.getOwnKeys(obj);
};
...
/**
     ...
     */
function gp(obj, {own = 1, distinct = 1, enumer = 1, user = 1} = {}) {
    let result = [];
