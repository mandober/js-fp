 ...
 */
function chprop (obj = {}, propName, propValue, bitmask = 4) {
    'use strict';
    // check args
    if (propName === undefined) return new Error("[chprop] Propery name must be provided");
    if (bitmask < 0 || bitmask > 7) return new Error("[chprop] Bitmask value, if supplied, must be 0-7 inclusive");
    // shorthands
