describe('Math trig functions', function() {
	it('should return correct values1', function() {
...
describe('Misc Math functions', function() {
	it('should return correct values2', function() {
		...
		//expect(Math.expm1(35)).toBe(1586013452313429.2);
...
describe('Other Math functions', function() {
	it('should return correct values3', function() {
